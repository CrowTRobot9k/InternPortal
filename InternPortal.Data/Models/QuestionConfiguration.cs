...
namespace InternPortal.Data.Models
{
    ...
    public partial class QuestionConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<Question>
    {
        ...
        public QuestionConfiguration(string schema)
        {
            ...
            // Foreign keys
            HasRequired(a => a.QuestionType).WithMany(b => b.Questions).HasForeignKey(c => c.QuestionTypeId).WillCascadeOnDelete(false); // FK_dbo.Question_dbo.QuestionType_QuestionTypeId
            InitializePartial();
        }
